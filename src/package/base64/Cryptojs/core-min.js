  ...
  var k = {}, l = k.lib = {}, n = function () {
    ...
    j = l.WordArray = f.extend({
      ...
      concat: function (a) {
        ...
        a = a.sigBytes
        this.clamp()
        if (c % 4) for (var e = 0; e < a; e++)b[c + e >>> 2] |= (d[e >>> 2] >>> 24 - 8 * (e % 4) & 255) << 24 - 8 * ((c + e) % 4); else if (d.length > 65535) for (e = 0; e < a; e += 4)b[c + e >>> 2] = d[e >>> 2]; else b.push.apply(b, d)
        this.sigBytes += a
        return this
      },
      clamp: function () {
